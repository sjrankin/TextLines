...
public class Versioning: CustomStringConvertible
{
    ...
    public static let MinorVersion: String = "4"
    ...
    public static let ProgramID = "019d347e-4300-46c9-9a55-0fe4da7389d0"
    
    /// The intended OS for the program.
    public static let IntendedOS: String = "iOS"
    
    /// Minimum supported OS version.
    public static let MinimumOS: String = "15.0"
    ...
    public static let Build: Int = 1958
    
    /// Build increment. Value to use to increment the build number.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "FECB9BBE-14A7-43E6-B422-CC655A80CC08"
    
    /// Build date.
    public static let BuildDate: String = "24 November 2021"
    
    /// Build Time.
    public static let BuildTime: String = "10:45"
    
    /// Holds the release build flag.
#if DEBUG
    private static var _IsReleaseBuild: Bool = false
#else
    private static var _IsReleaseBuild: Bool = true
#endif
    /// Get or set the release build flag.
    ...
    /// Copyright years.
    public static let CopyrightYears = [2021]
